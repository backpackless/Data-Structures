 ...
 * PURPOSE: Interface of the Stack ADT
 ...
 *              not greater than the size of the Stack.
 *            . The Stack should not be full.
 * ENSURES: . Empty will return false (0).
 *          . Stack will return the first integer greater
 ...
 * ARGUMENTS: . The address of the Stack (Stack *L)
